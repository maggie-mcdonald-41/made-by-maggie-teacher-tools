...
function buildSummary() {
  ...
  function setSessionInfo(info = {}) {
    ...
    state.sessionInfo = {
      ...
      ownerEmail,
      gradeLevel: cleanString(info.gradeLevel || info.grade || window.READING_GRADE_LEVEL || "7"),
      grade: cleanString(info.grade || info.gradeLevel || window.READING_GRADE_LEVEL || "7"),
